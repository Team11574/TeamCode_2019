...
public class AutoBlueTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //move back and move the pantagraph down
        {
            Robot.resetTime();
            double[] powers = motorPower.calcMotorsFull(0, .4, 0); //move back into wall slowly
            ElapsedTime pantTime = new ElapsedTime();
            Robot.setMotors(powers, 1);
        ...
        Robot.reset_pow();
        moveDirMax(-1,0,0,1000,14000); //maybe this could be diagonal
        //would have to scale distanec to sqrt(2)
